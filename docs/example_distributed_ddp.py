"""This script demonstrates distributed execution using PyTorch's DistributedDataParallel
...
def run_rank(rank, world_size):
    ...
    nt = 300
    observed_data = taper(observed_data_full[:n_shots, :n_receivers_per_shot, :nt])
