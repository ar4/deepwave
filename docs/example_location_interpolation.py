...
plt.figure(figsize=(10.5, 7))
plt.plot(receiver_amplitudes[0, 0].cpu().T, label='Monopole')
plt.plot(receiver_amplitudes[0, 1].cpu().T, label='Dipole 0')
plt.plot(receiver_amplitudes[0, 2].cpu().T, label='Dipole 1')
plt.legend()
...
plt.figure(figsize=(10.5, 7))
plt.plot(receiver_amplitudes[0, 0].cpu().T, label='Hicks', linewidth=6)
plt.plot(receiver_amplitudes2[0, 0].cpu().T, 'g', label='Without Hicks')
plt.plot(receiver_amplitudes3[0, 0].cpu().T, 'r', label='Denser grid')
plt.legend()
plt.xlabel('Time sample')
plt.ylabel('Receiver amplitude')
